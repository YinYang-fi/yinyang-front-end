...
const AddressButton: React.FC<AddressButtonProps> = ({ name, address, to, uniswap, unitext, unilink }) => {
    ...
    if (uniswap) {
      return (
        <>
          ...
          <StyledLink
            darkMode={darkMode}
            href={unilink ? unilink + address : "https://pancakeswap.finance/swap?inputCurrency=" + address}
            target="_blank"
            color="white"
            overflow="true"
          >
  ...
  }, [darkMode, uniswap, address, unilink, unitext]);
      ...
      <Box row>
        <StyledButton darkMode={darkMode} uniswap={uniswap}>
          <StyledSpan>
            ...
            <StyledLink darkMode={darkMode} color="hsl(339deg 89% 49% / 100%)" href={"https://bscscan.com/address/" + address} target="_blank">
              {DisplayAddress}
            </StyledLink>
            <StyledCopy
              darkMode={darkMode}
